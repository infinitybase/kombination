...
export function Welcome() {
  return (
    <div className="w-full flex flex-col-reverse md:flex-col items-center bg-primary text-white font-mono max-w-screen">
      <Navigation />

      {/* Main Content - Responsive for all screen sizes */}
      <div className="flex flex-col md:flex-row w-screen max-w-[1600px]">
        {/* Image Section */}
        <div className="w-full md:w-[60%] flex justify-center py-6 sm:py-8 md:py-0 bg-orange-light">
            <img 
              src={KombiWelcome} 
              alt="Kombi" 
        ...
        {/* Auction Section */}
        <div className="w-full md:w-[40%] p-4 sm:p-6 lg:p-8 flex flex-col items-center gap-6">
          {/* Content Section */}
          <div className="w-full flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6">
            ...
            <p className="text-[10px] sm:text-xs md:text-sm lg:text-base text-beige-primary">
            ...
            <div className="flex gap-2 sm:gap-3 md:gap-4">
              <span className="bg-yellow-primary text-background-primary px-2 sm:px-3 md:px-4 py-1 md:py-2 text-[10px] sm:text-xs">Type 1</span>
              <span className="bg-yellow-primary text-background-primary px-2 sm:px-3 md:px-4 py-1 md:py-2 text-[10px] sm:text-xs">1.5L</span>
              <span className="bg-yellow-primary text-background-primary px-2 sm:px-3 md:px-4 py-1 md:py-2 text-[10px] sm:text-xs">150.000km</span>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col gap-2 pt-4 text-beige-primary">
